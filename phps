...
phps_switch_usage() {
  ...
  if [[ -n $long_usage ]]; then
    ...
    printf "    Allowed: 5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2, auto\n"
    printf "    Default: auto\n"
    echo
...
phps_switch_parse_requirements() {
  ...
  if [[ -n ${args['version']} ]] && [[ ! ${args['version']} =~ ^(5.6|7.0|7.1|7.2|7.3|7.4|8.0|8.1|8.2|auto)$ ]]; then
    printf "%s\n" "version must be one of: 5.6, 7.0, 7.1, 7.2, 7.3, 7.4, 8.0, 8.1, 8.2, auto" >&2
    exit 1
  fi
